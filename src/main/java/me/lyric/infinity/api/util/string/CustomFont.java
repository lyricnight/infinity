...
public class CustomFont
{
    ...
    //may cause crashes. lets see if this works
    private final Fonts FONT = Managers.MODULES.getModuleByClass(Fonts.class);
    ...
    {
        if (FONT.isEnabled() && FONT.changeHeight.getValue())
        {
            return (fontHeight - FONT.heightSub.getValue()) / FONT.heightFactor.getValue() + FONT.heightAdd.getValue();
        }

...
public class PanelStudioGUI extends MinecraftGUI {
    ...
    public PanelStudioGUI() {
        ...
        // Pop-up Panel
        IComponentAdder popupPanelAdder = new PanelAdder(gui, false, () -> ClickGUI.clickGUI.layout.getValue() == ClickGUI.Layout.PopupPanel, title -> "popupPanel_" + title) {
            @Override
            protected IResizable getResizable(int width) {
                return resizable.apply(width);
            }
        ...
        // Draggable Panel
        IComponentAdder draggablePanelAdder = new PanelAdder(gui, false, () -> ClickGUI.clickGUI.layout.getValue() == ClickGUI.Layout.DraggablePanel, title -> "draggablePanel_" + title) {
            @Override
            protected IResizable getResizable(int width) {
                return resizable.apply(width);
            }
        ...
        // Single Panel
        IComponentAdder singlePanelAdder = new SinglePanelAdder(gui, new Labeled("Example Menu", null, () -> true), theme, new Point(10, 10), WIDTH * Category.values().length, animation, () -> ClickGUI.clickGUI.layout.getValue() == ClickGUI.Layout.SinglePanel, "singlePanel") {
            @Override
            protected IResizable getResizable(int width) {
                return resizable.apply(width);
            }
        ...
        // Panel Menu
        IComponentAdder panelMenuAdder = new StackedPanelAdder(gui, new Labeled("Example Menu", null, () -> true), theme, new Point(10, 10), WIDTH, animation, ChildMode.POPUP, new PanelPositioner(new Point(0, 0)), () -> ClickGUI.clickGUI.layout.getValue() == ClickGUI.Layout.PanelMenu, "panelMenu");
        ...
        // Color Panel
        IComponentAdder colorPanelAdder = new PanelAdder(gui, false, () -> ClickGUI.clickGUI.layout.getValue() == ClickGUI.Layout.ColorPanel, title -> "colorPanel_" + title) {
            @Override
            protected IResizable getResizable(int width) {
                return resizable.apply(width);
            }

...
public class HUD extends Module {
    ...
    public void draw(final RenderGameOverlayEvent.Text event) {
        ...
        if (activeModules.getValue()) {
            ...
            for (Module module : new ArrayList<>(modules)) {
                ...
                deltaY += (((Managers.FONT.getStringHeight()) + 1) * module.animfactor);
            }
        }
        if (info.getValue()) {
        ...
        if (coordinates.getValue())
        {
            ...
            Managers.FONT.drawString(EntityUtil.getFacing(mc.player.getHorizontalFacing().getName().toUpperCase()), 2, 530 - Managers.FONT.getStringHeight() - k, getTextColor((int) (530 - Managers.FONT.getStringHeight())).getRGB(), shadow.getValue());
            if (inHell) {
    ...
    public void renderGreeter() {
        ...
        Managers.FONT.drawString(welcomerString, width / 2.0f - Managers.FONT.getStringWidth(welcomerString) + 2.0f, 2, getTextColor(2).getRGB(), shadow.getValue());
    }
